...
public class RadiusLogoutJpaEntityProviderFactoryTest extends AbstractRadiusTest {
    private RadiusLogoutJpaEntityProviderFactory radiusLogoutJpaEntityProviderFactory = new RadiusLogoutJpaEntityProviderFactory();
    ...
    public void testMethods() {
        ...
        assertEquals(radiusLogoutJpaEntityProviderFactory.getId(), RADIUS_DISCONNECT_MESSAGE_FACTORY);
