...
***requirements***: [keycloak 23.0.4](https://github.com/keycloak/keycloak/releases/download/23.0.4/keycloak-23.0.4.zip)
```bash
...
```
where
- **KEYCLOAK_PATH** - Path where you are unpacked keycloak-23.0.4.zip [(you can use RADIUS_CONFIG_PATH instead of KEYCLOAK_PATH)](#environment-variables)
