...
***requirements***: [keycloak 21.1.1](https://github.com/keycloak/keycloak/releases/download/21.1.1/keycloak-21.1.1.zip)
```bash
...
```
where
- **KEYCLOAK_PATH** - Path where you are unpacked keycloak-21.1.1.zip [(you can use RADIUS_CONFIG_PATH instead of KEYCLOAK_PATH)](#environment-variables)
