...
### Configure keycloak
***requirements***: [keycloak 15.0.1](https://github.com/keycloak/keycloak/releases/download/15.0.1/keycloak-15.0.1.zip)
...
where
- **KEYCLOAK_PATH** - Path where you are unpacked keycloak-15.0.1.zip [(you can use RADIUS_CONFIG_PATH instead of KEYCLOAK_PATH)](#environment-variables)
