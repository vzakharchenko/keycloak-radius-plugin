...
### Configure keycloak
***requirements***: [keycloak 16.1.1](https://github.com/keycloak/keycloak/releases/download/16.1.1/keycloak-16.1.1.zip)
...
where
- **KEYCLOAK_PATH** - Path where you are unpacked keycloak-16.1.1.zip [(you can use RADIUS_CONFIG_PATH instead of KEYCLOAK_PATH)](#environment-variables)
