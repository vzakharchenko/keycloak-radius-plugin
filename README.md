...
***requirements***: [keycloak 24.0.1](https://github.com/keycloak/keycloak/releases/download/24.0.1/keycloak-24.0.1.zip)
```bash
...
```
where
- **KEYCLOAK_PATH** - Path where you are unpacked keycloak-24.0.1.zip [(you can use RADIUS_CONFIG_PATH instead of KEYCLOAK_PATH)](#environment-variables)
