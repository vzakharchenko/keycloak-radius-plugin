...
***requirements***: [keycloak 24.0.2](https://github.com/keycloak/keycloak/releases/download/24.0.2/keycloak-24.0.2.zip)
```bash
...
```
where
- **KEYCLOAK_PATH** - Path where you are unpacked keycloak-24.0.2.zip [(you can use RADIUS_CONFIG_PATH instead of KEYCLOAK_PATH)](#environment-variables)
