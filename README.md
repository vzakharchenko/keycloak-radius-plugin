...
***requirements***: [keycloak 25.0.4](https://github.com/keycloak/keycloak/releases/download/25.0.4/keycloak-25.0.4.zip)
```bash
...
```
where
- **KEYCLOAK_PATH** - Path where you are unpacked keycloak-25.0.4.zip [(you can use RADIUS_CONFIG_PATH instead of KEYCLOAK_PATH)](#environment-variables)
