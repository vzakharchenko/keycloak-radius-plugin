...
### Configure keycloak
***requirements***: [keycloak 12.0.2](https://github.com/keycloak/keycloak/releases/download/12.0.2/keycloak-12.0.2.zip)
...
where
- **KEYCLOAK_PATH** - Path where you are unpacked keycloak-12.0.2.zip
