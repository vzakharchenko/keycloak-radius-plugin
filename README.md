...
***requirements***: [keycloak 25.0.6](https://github.com/keycloak/keycloak/releases/download/25.0.6/keycloak-25.0.6.zip)
```bash
...
```
where
- **KEYCLOAK_PATH** - Path where you are unpacked keycloak-25.0.6.zip [(you can use RADIUS_CONFIG_PATH instead of KEYCLOAK_PATH)](#environment-variables)
